!(function(e) {
  ...
  function(e, t, n) {
    ...
    ;(function(e, n) {
      ...
      function Ne(e, t) {
        ...
        for (
          ...
          '__ob__' !== (n = o[a]) &&
            ((r = e[n]),
            (i = t[n]),
            w(e, n) ? r !== i && l(r) && l(i) && Ne(r, i) : Te(e, n, i))
        return e
      }
      function Me(e, t, n) {
        return n
      ...
      ;(Pe.data = function(e, t, n) {
        ...
        (Pe.props = Pe.methods = Pe.inject = Pe.computed = function(
          e,
          t,
          n,
          r
                ...
                i((c = t[r])) ||
                  ...
                  Array.isArray(c)
                    ? c.length > 0 &&
                      (dt((c = e(c, (n || '') + '_' + r))[0]) &&
                        dt(l) &&
                        ((f[u] = _e(l.text + c[0].text)), c.shift()),
                      f.push.apply(f, c))
                    : s(c)
                    ? dt(l)
                      ? (f[u] = _e(l.text + c))
      ...
      function wt(e) {
        return Fe(this.$options, 'filters', e) || M
      }
      function $t(e, t) {
      ...
      function Mt(e, t, n, i, o) {
        ...
        ;(this.data = e),
          ...
          (this.slots = function() {
            return (
              c.$slots || mt(e.scopedSlots, (c.$slots = vt(n, i))), c.$slots
            )
          }),
          ...
          if ((c(e) && (e = l.extend(e)), 'function' == typeof e)) {
                      ...
                      c(h) &&
                        (p(h)
                          ...
                          : p(h.component) &&
                            ...
                            o(h.error) && (e.errorComp = Vt(h.error, t)),
                            o(h.loading) &&
            ...
            if (a(e.options.functional))
              return (function(e, t, n, i, a) {
                ...
                if (d instanceof me) return It(d, n, f.parent, s, f)
                if (Array.isArray(d)) {
                  for (
                    var p = ft(d) || [], v = new Array(p.length), h = 0;
                    h < p.length;
                    h++
                  )
                    v[h] = It(p[h], n, f.parent, s, f)
                  return v
                }
              })(e, d, t, n, s)
            var v = t.on
            ...
            return new me(
              ...
              void 0,
              n,
              { Ctor: e, propsData: d, listeners: v, tag: u, children: s },
              f
            )
          }
        }
            ...
            if ('string' == typeof t) {
              ...
              ;(l = (e.$vnode && e.$vnode.ns) || B.getTagNamespace(t)),
                (u = B.isReservedTag(t)
                  ...
                  : (n && n.pre) || !o((f = Fe(e.$options, 'components', t)))
      ...
      function Zt(e, t, n) {
        ;(Ht = e), ct(t, n || {}, Jt, Wt, Gt, e), (Ht = void 0)
      }
      var Xt = null
      function Yt(e) {
        var t = Xt
      ...
      function yn(e) {
        ...
        t.props &&
          ...
          t.methods &&
            (function(e, t) {
              e.$options.props
              for (var n in t) e[n] = 'function' != typeof t[n] ? P : S(t[n], e)
            })(e, t.methods),
          t.data
            ? (function(e) {
          ...
          t.computed &&
            (function(e, t) {
              ...
              for (var i in t) {
                ...
                0, r || (n[i] = new vn(e, a || P, P, gn)), i in e || _n(e, i, o)
              }
            })(e, t.computed),
          t.watch &&
            t.watch !== ne &&
      ...
      function _n(e, t, n) {
        var r = !oe()
        'function' == typeof n
          ? ((hn.get = r ? bn(t) : wn(n)), (hn.set = P))
          : ((hn.get = n.get ? (r && !1 !== n.cache ? bn(t) : wn(n.get)) : P),
            (hn.set = n.set || P)),
        ...
        e.prototype._init = function(e) {
          ...
          ;(t._uid = xn++),
            ...
            e && e._isComponent
              ...
              : (t.$options = Re(Cn(t.constructor), e || {}, t)),
            (t._renderProxy = t),
            (t._self = t),
            (function(e) {
              var t = e.$options,
      ...
      function hr(e, t) {
        ...
        if (
          ...
          for (r in ((X || Q) && u.value !== c.value && mr(s, 'value', u.value),
          c))
            i(u[r]) &&
              (Bn(r)
      ...
      function zr(e, t) {
        var n = (function(e) {
          if (
            ((e = e.trim()),
            (br = e.length),
            e.indexOf('[') < 0 || e.lastIndexOf(']') < br - 1)
          )
            return (xr = e.lastIndexOf('.')) > -1
              ? { exp: e.slice(0, xr), key: '"' + e.slice(xr + 1) + '"' }
              : { exp: e, key: null }
          ;(wr = e), (xr = Cr = Or = 0)
          for (; !Kr(); ) qr(($r = Vr())) ? Wr($r) : 91 === $r && Jr($r)
          return { exp: e.slice(0, Cr), key: e.slice(Cr + 1, Or) }
        })(e)
        return null === n.key
          ? e + '=' + t
          : '$set(' + n.exp + ', ' + n.key + ', ' + t + ')'
      ...
      function ri(e, t) {
        if (!i(e.data.domProps) || !i(t.data.domProps)) {
          var n,
            ...
            s = e.data.domProps || {},
            c = t.data.domProps || {}
          for (n in (o(c.__ob__) && (c = t.data.domProps = E({}, c)), s))
            n in c || (a[n] = '')
          for (n in c) {
      ...
      var ui,
        ...
        di = function(e, t, n) {
          if (li.test(t)) e.style.setProperty(t, n)
            ...
            e.style.setProperty(k(t), n.replace(fi, ''), 'important')
          else {
            var r = vi(t)
            if (Array.isArray(n))
      ...
      $i &&
        ...
        void 0 === window.onanimationend &&
          ...
          ((Oi = 'WebkitAnimation'), (Ai = 'webkitAnimationEnd')))
      var ki = J
          ...
          if (!k || w || '' === w) {
            ...
            var D = !1 !== a && !Y,
              ...
              F = (n._enterCb = L(function() {
                D && (Ei(n, E), Ei(n, T)),
                  F.cancelled ? (D && Ei(n, S), M && M(n)) : N && N(n),
                  (n._enterCb = null)
              }))
            e.data.show ||
              ...
              D &&
                ...
                Si(function() {
                  Ei(n, S),
                    F.cancelled ||
                      (Ti(n, E), R || (Ri(I) ? setTimeout(F, I) : ji(n, s, F)))
                })),
          ...
          $.cancelled ||
            ...
            _ &&
              ...
              Si(function() {
                Ei(n, u),
                  $.cancelled ||
                    (Ti(n, l), b || (Ri(w) ? setTimeout($, w) : ji(n, s, $)))
              })),
            p && p(n, $),
            _ || b || $())
        }
      ...
      var Ui = (function(e) {
        ...
        for (t = 0; t < or.length; ++t)
          for (r[or[t]] = [], n = 0; n < c.length; ++n)
            o(c[n][or[t]]) && r[or[t]].push(c[n][or[t]])
        function l(e) {
        ...
        function y(e, n) {
          ...
          o((t = e.data.hook)) &&
            (o(t.create) && t.create(ir, e), o(t.insert) && n.push(e))
        }
        function g(e) {
          var t
        ...
        return function(e, t, n, s) {
          if (!i(t)) {
            ...
            if (i(e)) (l = !0), f(t, d)
              ...
              var p = o(e.nodeType)
              if (!p && ar(e, t)) C(e, t, d, null, null, s)
              else {
                if (p) {
                  if (
                    (1 === e.nodeType &&
                ...
                var v = e.elm,
                  m = u.parentNode(v)
                if (
                  (f(t, d, v._leaveCb ? null : m, u.nextSibling(v)),
                  o(t.parent))
                )
      ...
      ;(On.config.mustUseProp = In),
        ...
        E(On.options.directives, Xi),
        E(On.options.components, uo),
        (On.prototype.__patch__ = J ? Ui : P),
      ...
      function sa(e, t) {
        ...
        ;(function(e) {
          ...
          (Uo = jr(t.modules, 'transformNode')),
          (Ho = jr(t.modules, 'preTransformNode')),
          ...
          (function(e, t) {
            ...
            function C() {
              ...
              if (t) {
                ...
                for (
                  x(t[0].length);
                  !(n = e.match(Ao)) && (r = e.match($o) || e.match(wo));
            ...
            start: function(e, n, a, s, f) {
              ...
              X &&
                ...
                (n = (function(e) {
                  for (var t = [], n = 0; n < e.length; n++) {
                    var r = e[n]
                    va.test(r.name) ||
                      ((r.name = r.name.replace(ha, '')), t.push(r))
                  }
                  return t
                })(n))
              var p,
              ...
              d && (v.ns = d),
                ('style' !== (p = v).tag &&
                  ...
                  oe() ||
                  (v.forbidden = !0)
              for (var h = 0; h < Ho.length; h++) v = Ho[h](v, t) || v
              c ||
                (!(function(e) {
                      ...
                      a.sync &&
                        ...
                        c
                          ...
                          : (Lr(e, 'update:' + C(r), s, null, !1, 0, u[t]),
                            k(r) !== C(r) &&
                              Lr(e, 'update:' + k(r), s, null, !1, 0, u[t])))),
                    (a && a.prop) ||
        ...
        return (
          ...
          (function e(t, n, r, i) {
            ...
            return o.exp
              ...
              : '' + a(o.block)
            function a(e) {
              return r ? r(e, n) : e.once ? Ra(e, n) : Da(e, n)
            }
      ...
      function Ua(e, t) {
        ...
        return (
          (n = n.replace(/,$/, '') + '}'),
          e.dynamicAttrs &&
            (n = '_b(' + n + ',"' + e.tag + '",' + Ja(e.dynamicAttrs) + ')'),
      ...
      function qa(e, t) {
        return 1 === e.type
          ...
          : (function(e) {
              return (
                '_v(' +
                (2 === e.type ? e.expression : Wa(JSON.stringify(e.text))) +
                ')'
              )
            })(e)
      }
  ...
  function(e, t, n) {
    ...
    ;(0, n(5).default)('51d926ce', r, !1, {})
  },
  function(e, t, n) {
    var r = n(12)
    'string' == typeof r && (r = [[e.i, r, '']]),
      r.locals && (e.exports = r.locals)
    ;(0, n(5).default)('b1ef4d60', r, !1, {})
  },
  function(e, t) {
    var n
    n = (function() {
  ...
  function(e, t, n) {
    ;(t = n(4)(!1)).push([
      e.i,
      '.card[data-v-54cdc180]{width:100%;padding:0 15px;margin-top:15px}@media screen and (min-width: 992px){.card[data-v-54cdc180]{width:33.333333%;margin-top:0}}.card .card-wrap[data-v-54cdc180]{background-color:#fff;border-radius:3px;box-shadow:0 0 15px rgba(30,47,67,0.15);text-align:center;padding:30px 20px}.card .card-title[data-v-54cdc180]{margin:0;font-family:sans-serif}.card .features[data-v-54cdc180]{padding:0;margin:0;list-style:none}.card .features li[data-v-54cdc180]{margin-top:10px}.card .toggle-features[data-v-54cdc180]{border:0;border-radius:40px;cursor:pointer;display:inline-block;font-family:sans-serif;font-size:16px;padding:15px 30px;text-align:center;text-decoration:none;transition:background-color 0.3s, box-shadow 0.3s, color 0.3s;background-color:#00a3ff;color:#fff;margin-top:15px}.card .toggle-features[data-v-54cdc180]:hover{background-color:#0082cc}\n',
      '',
    ]),
      (e.exports = t)
  },
  ...
  function(e, t, n) {
    ;(t = n(4)(!1)).push([
      e.i,
      'html{box-sizing:border-box;-ms-overflow-style:scrollbar}*,*::before,*::after{box-sizing:inherit}body{background-color:#f4f7fd}.container{margin:0 auto;max-width:1000px;padding:0 15px}.row{display:flex;flex-wrap:wrap;justify-content:center;align-items:flex-start;margin-left:-15px;margin-right:-15px}\n',
      '',
    ]),
      (e.exports = t)
  },
  function(e, t, n) {
            ...
            [
              t('card', {
                attrs: {
                  ...
                  description:
                    'v-show-slide with default options. No arguments set.',
                },
              }),
              this._v(' '),
              t('card', {
                attrs: {
                  ...
                  title: 'With Options',
                  description:
                    'v-show-slide with duration and easing arguments.',
                  duration: 500,
                  easing: 'ease-in',
                },
              }),
              ...
              t('card', {
                attrs: {
                  ...
                  title: 'Custom Easing',
                  description:
                    'v-show-slide with custom cubic-bezier easing set.',
                  duration: 400,
    ...
    var _ = g,
      b = function() {
        ...
        return n('div', { staticClass: 'card' }, [
          n('div', { staticClass: 'card-wrap' }, [
            n('div', { staticClass: 'card-header' }, [
              n('h2', { staticClass: 'card-title' }, [e._v(e._s(e.title))]),
            ]),
            e._v(' '),
            n('div', { staticClass: 'card-content' }, [
              ...
              n(
                'ul',
                {
                  directives: [
                    {
                      name: 'show-slide',
                      rawName: 'v-show-slide:[directiveArg]',
                      value: e.open,
                      expression: 'open',
                      arg: e.directiveArg,
                    },
                  ...
                  attrs: { id: e.id },
                  on: {
                    'slide-open-start': e.slideOpenStart,
                    'slide-open-end': e.slideOpenEnd,
                    'slide-close-start': e.slideCloseStart,
                    'slide-close-end': e.slideCloseEnd,
                  },
                },
                [
                  n('li', [e._v('Aliquam lorem')]),
                  e._v(' '),
                  n('li', [e._v('Praesent porttitor nulla vitae posuere')]),
                  e._v(' '),
                  n('li', [e._v('Suspendisse nisl elit rhoncus')]),
                  e._v(' '),
                  n('li', [e._v('Donec mi odio faucibus')]),
                  e._v(' '),
                  e._m(0),
                ]
              ),
              ...
              n(
                'button',
                {
                  staticClass: 'toggle-features',
                  attrs: {
                    'aria-controls': e.id,
                    'aria-expanded': e.open ? 'true' : 'false',
                  },
                  on: { click: e.toggleFeatures },
                },
                [
                  e._v(
                    '\n        ' +
                      e._s(e.open ? 'Hide Features' : 'View Features')
                  ),
                ]
              ),
            ]),
    ...
    b._withStripped = !0
    var w = 'undefined' != typeof Reflect && void 0 !== Reflect.getMetadata
    function $(e, t, n) {
      if (
        w &&
        !Array.isArray(e) &&
    ...
    var C,
      ...
      k = (function(e) {
        function t() {
          ...
          return (t.open = t.initialOpen), t
        }
        return (
          O(t, e),
          Object.defineProperty(t.prototype, 'directiveArg', {
            get: function() {
          ...
          (t.prototype.toggleFeatures = function() {
            this.open = !this.open
          }),
          (t.prototype.slideOpenStart = function() {
            console.log('Slide Open Start')
          }),
          (t.prototype.slideOpenEnd = function() {
            console.log('Slide Open End')
          }),
          (t.prototype.slideCloseStart = function() {
            console.log('Slide Close Start')
          }),
          (t.prototype.slideCloseEnd = function() {
            console.log('Slide Close End')
          }),
          A([x({ required: !0 })], t.prototype, 'id', void 0),
          A([x({ required: !0 })], t.prototype, 'title', void 0),
          A([x({ required: !0 })], t.prototype, 'description', void 0),
          A([x()], t.prototype, 'duration', void 0),
          A([x()], t.prototype, 'easing', void 0),
          A([x({ default: !1 })], t.prototype, 'initialOpen', void 0),
          (t = A([_], t))
        )
      })(r.a)
    n(9)
      ...
      [
        function() {
          var e = this.$createElement,
            t = this._self._c || e
          return t('li', [
            t('a', { attrs: { href: 'https://peterhegman.com' } }, [
              this._v('Focusable link'),
            ]),
          ])
        },
      ],
    ...
    T.options.__file = 'src/components/Card.vue'
    var E = T.exports,
      j = (function() {
        var e = function(t, n) {
          return (e =
      ...
      N = (function(e) {
        ...
        return j(t, e), (t = P([_({ components: { Card: E } })], t))
      })(r.a),
      M = (n(11), S(N, i, [], !1, null, null, null))
    M.options.__file = 'src/Demo.vue'
    var I = M.exports,
      D = function() {
        return (D =
          Object.assign ||
      ...
      R = {
        ...
        inserted: function(e, t) {
          this.initializeTarget(e, t.value)
        },
        componentUpdated: function(e, t) {
          this.toggleSlide(e, t)
        },
        getTargetByEl: function(e) {
          var t = this.targets.filter(function(t) {
            return t.el.isSameNode(e)
          })[0]
          if (void 0 === t) throw 'Element not found!'
          return t
        },
        setTargetPropertyByEl: function(e, t, n) {
          var r,
            i = this.getTargetByEl(e),
            o = this.targets.filter(function(t) {
              return !t.el.isSameNode(e)
            })
          this.targets = L(o, [D(D({}, i), ((r = {}), (r[t] = n), r))])
        },
        validateOptions: function(e) {
          void 0 !== e &&
            Object.prototype.hasOwnProperty.call(e, 'customEasing') &&
            (this.easingOptions.custom = e.customEasing)
        },
        ...
        fireEvent: function(e, t) {
          if ('function' == typeof window.CustomEvent)
            ...
            n.initCustomEvent(t, !1, !1, null), e.dispatchEvent(n)
          }
        },
        parseArgs: function(e, t) {
          if (
            Object.prototype.hasOwnProperty.call(t, 'arg') &&
            'string' == typeof t.arg
          ) {
            var n = t.arg.split(':'),
              r = this.validateEasing(n),
              i = this.validateDuration(n)
            this.targets.push({
              el: e,
              duration: i,
              durationInSeconds: i / 1e3 + 's',
              easing: r,
              isAnimating: !1,
            })
          } else
        ...
        validateEasing: function(e) {
          return Object.prototype.hasOwnProperty.call(e, 1)
            ? this.easingOptions.builtIn.indexOf(e[1]) > -1
              ? e[1]
              : Object.prototype.hasOwnProperty.call(
                  this.easingOptions.custom,
                  this.kebabToCamel(e[1])
                )
              ? this.easingOptions.custom[this.kebabToCamel(e[1])]
              : 'ease'
            : 'ease'
        },
        validateDuration: function(e) {
          return Object.prototype.hasOwnProperty.call(e, 0)
            ? parseInt(e[0])
            : 300
        },
        initializeTarget: function(e, t) {
          t || ((e.style.height = '0px'), (e.style.visibility = 'hidden'))
          var n = this.getTargetByEl(e),
            r = n.easing,
            i = n.durationInSeconds
          ;(e.style.overflow = 'hidden'),
            (e.style.transition = 'height ' + r + ' ' + i)
        },
        toggleSlide: function(e, t) {
          t.value !== t.oldValue &&
            (t.value ? this.slideOpen(e) : this.slideClosed(e))
        },
        slideOpen: function(e) {
          var t = this
          this.fireEvent(e, 'slide-open-start')
          var n = this.getTargetByEl(e),
            r = n.isAnimating,
            i = n.timeout,
            o = n.duration
          r && clearTimeout(i),
            this.setTargetPropertyByEl(e, 'isAnimating', !0),
          ...
          e.style.height = a + c + u + 'px'
          var l = setTimeout(function() {
            ;(e.style.height = 'auto'),
              t.setTargetPropertyByEl(e, 'isAnimating', !1),
              t.fireEvent(e, 'slide-open-end'),
              (e.style.overflow = 'visible')
          }, o)
          this.setTargetPropertyByEl(e, 'timeout', l)
        },
        slideClosed: function(e) {
          var t = this
          this.fireEvent(e, 'slide-close-start'), (e.style.overflow = 'hidden')
          var n = this.getTargetByEl(e),
            r = n.isAnimating,
            i = n.timeout,
            o = n.duration
          r && clearTimeout(i), this.setTargetPropertyByEl(e, 'isAnimating', !0)
          var a = e.scrollHeight
          e.style.height = a + 'px'
          e.offsetLeft
          e.style.height = '0px'
          var s = setTimeout(function() {
            t.setTargetPropertyByEl(e, 'isAnimating', !1),
              ...
              t.fireEvent(e, 'slide-close-end'),
              (e.style.overflow = 'visible')
          }, o)
          this.setTargetPropertyByEl(e, 'timeout', s)
        },
      }
    r.a.use(R, {
      customEasing: { exampleEasing: 'cubic-bezier(0.68, -0.55, 0.265, 1.55)' },
    }),
      new r.a({
        render: function(e) {
          return e(I)
